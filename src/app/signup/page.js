...
const SignUpPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Typically, you'd make an API call here to validate user credentials
      router.push('/login'); // Redireogin fct to the dashboard page after successful login
    } catch (error) {
      console.error('Login error:', error); // Log the error for debugging
      setError('Lailed. Please try again.');
    }
  };
